...
import {parent, wave, pizza, st0, layer3, pizzaAnimation} from './style.module.css';
  ...
  return (
    <div className={parent} >
      <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 500 500" style={{'enable-background': 'new 0 0 500 500; height: 20px; widht: 20px;'}} xmlSpace="preserve">
        <g id="Layer_2">
        ...
        <g id="Layer_1">
          ...
          <path className={wave} d="M182.5,264.8c1.1,9,22.4-0.9,26.8,4.2c4.4,5.1,17.9,10.9,21,11.7s5.9-1.1,7.5-2.8c1.7-1.7,0.4-5.2,0.4-5.2s-2.6-8.5,4.7-9
          ...
          <path className={wave} d="M282.5,178.7h73.2c0,0-11.7,28.7-36.6,28.7S282.5,178.7,282.5,178.7z"/>
          ...
          <g id={layer3}>
            <ellipse className={pizza+' '+ pizzaAnimation} cx="325.4" cy="calc(159.8px - 105px)" rx="92.5" ry="10.4"/>
          </g>
