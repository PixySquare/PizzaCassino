  ...
  return (
    <div className="woodBackground">
      ...
      <div className={styles.mainContent}>
        ...
        <hr style={{width: '30%', display: 'block',
        ...
        <ThemeProvider theme={theme}>
          ...
          {/* <TabContext value={value}>
                        ...
                        width:"50%",color:"#fff", marginLeft:"auto",
                        marginRight:"auto" }}>
                        ...
                        <TabPanel value="1">
                            ...
                            marginLeft:"10%"}}>All</h1>
                            <hr style={{width: '15%',display: 'block',
                             marginRight:"auto",marginLeft:"8%",
                             backgroundColor:"#F24C4C",borderColor:"#F24C4C"}}/>
                            <div style={{width:"90%",display: 'block',
                            marginRight:"auto",marginLeft:"auto",padding:30}}>
                                <MenuComponent data={AllMenu} />
                            </div>
                        </TabPanel>
                        <TabPanel value="2">
